...
GVAR2(ToggleVar,	tAutomapActiveRoom,		1,	0, (BYTE)-1	,1 )
GVAR2(ToggleVar,	tAutomapReadyRoom,		1,	0, (BYTE)-1	,1)
GVAR2(ToggleVar,	tAutomapScreenArea,		1,	0, (BYTE)-1	,1)
...
#ifdef PATH_INSTALL
	{PatchCALL,   DLLOFFSET2(D2CLIENT, 0x6FB10E16, 0x6FB21996),    (DWORD)RoomPatch_ASM,                   6 ,   &fDefault},
