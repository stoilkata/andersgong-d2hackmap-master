...
GVAR2(ToggleVar,	tDiagonalScroll,		1,	1, (BYTE)-1,		1 ,"Diagonal scroll Toggle" )
GVAR2(ToggleVar,	tScrollMap,				1,	0, (BYTE)-1,		1 )
GVAR2(ToggleVar,	tCenterMap,			    2,	0, (BYTE)-1,		1,	0,		&CenterMap)
...
GVAR2(ToggleVar,	tMapScrollKey[9]	, 	   {0})
  ...
  {PatchFILL,   DLLOFFSET2(D2CLIENT, 0x6FB3B16F, 0x6FB6607F),    INST_NOP,                               2 ,   &fDefault}, //force perspective shake
  {PatchFILL,   DLLOFFSET2(D2CLIENT, 0x6FAEF8DF, 0x6FB0BE3F),    INST_NOP,                               2 ,   &fDefault}, //force get shake
  {PatchFILL,   DLLOFFSET2(D2CLIENT, 0x6FB3B096, 0x6FB65FA6),    INST_NOP,                               15,   &fDefault}, //kill add shake
  {PatchFILL,   DLLOFFSET2(D2CLIENT, 0x6FB3B0A5, 0x6FB65FB5),    INST_NOP,                               2 ,   &fDefault}, //kill add shake, part 2
  {PatchFILL,   DLLOFFSET2(D2CLIENT, 0x6FB0FB10, 0x6FB20710),    INST_NOP,                               0x37, &fDefault}, //kill automap scroll, wipe out 4 adjustments
