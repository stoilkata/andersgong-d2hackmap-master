...
GVAR2(ToggleVar,	tRuneNumbers,		1,	1,	(BYTE)-1,	1,"Rune numbers")
GVAR2(ToggleVar,	tSocketNumbers,		1,	1,	(BYTE)-1,	1,"Socket numbers")
GVAR2(ToggleVar,	tItemLevel,			1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemValue,			1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemIndex,			1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemFileIndex,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tUnitNumber,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemQLevel,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemMLevel,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tItemALevel,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tAfterCube,			1,	0,	(BYTE)-1,	1, 0)
GVAR2(ToggleVar,	tLifePerLevel,		1,	0,	(BYTE)-1,	1, 0)
GVAR2(DWORD,		dwItemValueNpc[5],	154,178,255,405,513 )
GVAR2(ToggleVar,	tShowBaseED,				1,	0,	(BYTE)-1,	1 , "Show Base ED")
#endif

#ifdef PATH_INSTALL

  {PatchCALL,   DLLOFFSET2(D2CLIENT, 0x6FB42366, 0x6FB46736),    (DWORD)ItemNamePatch_ASM,               6 ,   &fDefault}, 
  {PatchCALL,   DLLOFFSET2(D2CLIENT, 0x6FB444F1, 0x6FB488C1),    (DWORD)OpenCubeStringPatch_ASM,         5 ,   &fDefault}, 
  {PatchVALUE,  DLLOFFSET2(D2CLIENT, 0x6FB70017, 0x6FAC9A17),    0xe990,                                 2 ,   &fDefault},  //kill ground gold name
