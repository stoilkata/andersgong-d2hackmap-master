	...
	GVAR2(ToggleVar,	tItemExtInfo,			1,	0,	(BYTE)-1,	1 , 0 , &LoadExtInfo)
	GVAR (BYTE,			nDefaultExtInfoColour,				8)
#endif

#ifdef PATH_INSTALL
{PatchCALL,   DLLOFFSET2(D2CLIENT, 0x6FB73D91, 0x6FACD791),    (DWORD)DrawHoverPatch_ASM,             5 ,   &fDefault},//单独找个地方显示，保持独立
