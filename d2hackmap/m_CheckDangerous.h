...
GVAR2(ToggleVar,	tChickenLife,			1,	0,	(BYTE)-1,	1,	"Chicken life")
GVAR2(ToggleVar,	tChickenHostile,		1,	0,	(BYTE)-1,	1,	"Chicken hostile")
GVAR2(ToggleVar,	tChickenHostileNearby,	1,	0,	(BYTE)-1,	1,	"Chicken hostile nearby")
GVAR2(ToggleVar,	tChickenDangerousMonster,		1,	0,	(BYTE)-1,	1, "Chicken Dangerous Monster")
