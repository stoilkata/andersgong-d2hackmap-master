...
GVAR2(ToggleVar,	tExitGame,			2,	0,	(BYTE)-1,	 1, 	0,	&QuickExitGame, 0)
GVAR2(ToggleVar,	tQuickNextGame,		3,	0,	(BYTE)-1,	 1, 	0,	&QuickNextGame,	1)
GVAR2(ToggleVar,	tQuickNextGame2,	3,	0,	(BYTE)-1,	 1, 	0,	&QuickNextGame,	2)
...
GVAR (BOOL,			fCanExitGame,				FALSE)
	...
	{PatchCALL,   DLLOFFSET2(D2MULTI, 0x6F9E4A0B, 0x6F9DADAB),   (DWORD)NextGameNamePatch,           5 ,   &fDefault},
    {PatchCALL,   DLLOFFSET2(D2MULTI, 0x6F9E4A46, 0x6F9DADE6),   (DWORD)NextGamePasswordPatch,       5 ,   &fDefault},
    {PatchCALL,   DLLOFFSET2(D2MULTI, 0x6F9E4D29, 0x6F9DB5E9),   (DWORD)NextGameNamePatch,           5 ,   &fDefault},
    {PatchCALL,   DLLOFFSET2(D2MULTI, 0x6F9E4D64, 0x6F9DB624),   (DWORD)NextGamePasswordPatch,       5 ,   &fDefault},
