...
GVAR2(ToggleVar,	tRevealAct,				2,	0, (BYTE)-1,		1,  0,			&RevealAutomap)
GVAR2(ToggleVar,	tRevealLevel,			2,	0, (BYTE)-1,		1,  0,			&RevealLevelPlayerIn)
GVAR2(ToggleVar,	tAutoMap,				1,	1, (BYTE)-1,		1, "Auto Map Toggle"	)
