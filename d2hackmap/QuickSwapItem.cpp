...
void  MoveItem(D2MSG *pMsg ){
	...
	//d2hackmap的快速移动物品功能默认支持的分辨率是800*600(没有设定对应不同分辨率的相对坐标)
	static InventoryType invTypes[] = {   //left和bottom已经偏移了格子一半大小
		{0, 430, 325, 10, 4, 29, 29}, // Inventory 人物的背包
		{4, 165, 152, 6, 8, 29, 29}, // Stash  资料片储物箱 
		//4代表type为stash(非资也是这个，区别是后面的坐标)，165是left，152是bottom，后面的6和8是x行y列，29和29代表W/H(这个不用管)。
		//你需要改的其实只有165,152,6,8这4个数字，可以根据你分辨率和大箱子坐标来自己修改
		{3, 220, 220, 3, 4, 29, 29}, // Cube 盒子空间
		{4, 165, 345, 6, 4, 29, 29}, // Stash_Classic 非资储物箱
		{2, 110, 325, 10, 4, 29, 29}, // Trade 1 for others trade 交易模式下你的物品栏
	};
